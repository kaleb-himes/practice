...
public class customer {
    ...
    public static void main(String args[]) {
        ...
        cart[1] = product_factory.createProduct("Lucky Winner Discount");
        ...
        cart[5] = product_factory.createProduct("Lucky Winner Discount");
        ...
        cart[9] = product_factory.createProduct("Lucky Winner Discount");
        cart[10] = product_factory.createProduct("Baby Food");
        cart[11] = product_factory.createProduct("Baby Food");
        cart[12] = product_factory.createProduct("Lucky Winner Discount");
        ...
        cart[17] = product_factory.createProduct("Lucky Winner Discount");
